...
describe("Registrant", function () {
  ...
  it("should be able to earn a permit if 16 or older", function () {
    ...
    assert.equal(
      ...
      "You have successfully earned a permit!",
    );
  });
  ...
  it("should not be able to earn a permit if under 16", function () {
    ...
    assert.equal(
      earnPermit(registrant),
      "Sorry, you are not able to earn a permit right now.",
    );
  });
  ...
  it.skip("should be able to take a license exam because they have earned a permit", function () {
    ...
    assert.equal(
      ...
      "Great job! You can take your test.",
    );
  });
  ...
  it.skip("should not be able to take a license exam without a permit", function () {
    ...
    assert.equal(
      takeLicenseExam(registrant),
      "Sorry, you need to earn a permit first.",
    );
  });
});
